...
router
  .route("/admin/orders")
  .get(isAuthenticUser, authorizeRoles("admin"), getAllOrders);

router
  .route("/admin/order/:id")
  .put(isAuthenticUser, authorizeRoles("admin"), updateOrder)
  .delete(isAuthenticUser, authorizeRoles("admin"), deleteOrder);
