export default function Example() {
  return (
    <>
      <div>
        <div className="mt-1 p-20 sm:mt-0">
                ...
                <div className="shadow sm:rounded-md sm:overflow-hidden">
                  <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                      ...
                      <div className="col-span-3 sm:col-span-2">
                        ...
                        <div className="mt-1 flex rounded-md shadow-sm">
                          ...
                          <input
                            ...
                            id="company-website"
                            className="p-2 focus:ring-blue-500 focus:border-blue-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300"
                    ...
                    <div>
                      ...
                      <div className="mt-1 p-2">
                        <textarea
                          ...
                          name="about"
                          rows={3}
                          className="shadow-sm focus:ring-blue-500 focus:border-blue-500 mt-1 p-2 block w-full sm:text-sm border border-gray-300 rounded-md"
                    ...
                    <div>
                      ...
                      <div className="mt-1 p-2 flex items-center">
                    ...
                    <div>
                      ...
                      <div className="mt-1 p-2 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
